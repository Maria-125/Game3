...
public class ToxicTrash extends GameObject {
    private Texture texture;
    private int points = 10;

    public ToxicTrash(World world, float x, float y) {
        super(world, x, y, 110, 110, GameSettings.TRASH_BIT);
        texture = new Texture(GameResources.TRASH_PATH);
        setVelocity(0, -5);
    }
